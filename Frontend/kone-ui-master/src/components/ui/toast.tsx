...
>(({ className, variant = 'default', ...props }, ref) => (
  <ToastPrimitive.Root
    ref={ref}
    className={cn(
      'flex items-start justify-between gap-3 rounded-lg border px-4 py-3 shadow-sm text-sm transition-all',
      variant === 'destructive'
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ref={ref}
    className={cn('text-gray-400 hover:text-gray-600 transition-colors duration-150', className)}
    {...props}
  >
