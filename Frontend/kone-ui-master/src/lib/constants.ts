...
export const KONE_COMPONENTS: ComponentItem[] = [
  {
    ...
    variants: [
      ...
      { id: 'stainless-steel-smooth', group: 'Elevator Interior - India', label: 'Stainless steel smooth', imageUrl: '/components/elevator-interior/Stainless Steel Smooth.png' },
      { id: 'stainless-steel-honeycomb', group: 'Elevator Interior - India', label: 'Stainless steel honeycomb', imageUrl: '/components/elevator-interior/Stainless Steel Honeycomb.png' },
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'kds330-lci-flush', group: 'KDS330/93/96', label: 'Landing Call Indicator Flush', imageUrl: '/components/lci/KDS330/Landing Call Indicator Flush.png' },
      { id: 'kds330-lci-surface', group: 'KDS330/93/96', label: 'Landing Call Indicator Surface', imageUrl: '/components/lci/KDS330/Landing Call Indicator Surface.png' },
      { id: 'kds330-hall-lantern-flush-up-down', group: 'KDS330/93/96', label: 'Hall Lantern Flush - Up/Down', imageUrl: '/components/lci/KDS330/Hall Lantern Flush - Up Down.png' },
      { id: 'kds330-hall-lantern-surface', group: 'KDS330/93/96', label: 'Hall Lantern Surface', imageUrl: '/components/lci/KDS330/Hall Lantern Surface.png' },
      { id: 'kds330-hall-indicator-flush-7-segment', group: 'KDS330/93/96', label: 'Hall Indicator Flush - 7 Segment', imageUrl: '/components/lci/KDS330/Hall Indicator Flush - 7 Segment.png' },
      { id: 'kds330-hall-indicator-surface', group: 'KDS330/93/96', label: 'Hall Indicator Surface', imageUrl: '/components/lci/KDS330/Hall Indicator Surface.png' },
      { id: 'kds330-landing-call-station-flush', group: 'KDS330/93/96', label: 'Landing Call Station Flush', imageUrl: '/components/lci/KDS330/Landing Call Station Flush.png' },
      { id: 'kds330-landing-call-station-surface', group: 'KDS330/93/96', label: 'Landing Call Station Surface', imageUrl: '/components/lci/KDS330/Landing Call Station Surface.png' },
      { id: 'kds330-kds-96', group: 'KDS330/93/96', label: 'KDS 96', imageUrl: '/components/lci/KDS330/KDS 96.png' },
    ],
  },
  {
    key: 'dcs1020',
    ...
    variants: [
      ...
      { id: 'dcs1020-kst-850-860-i', group: 'DCS1020', label: 'KST 850/860 I', imageUrl: '/components/lci/DCS1020/KST 850-860 I.png' },
      { id: 'dcs1020-kst-850-860-ii', group: 'DCS1020', label: 'KST 850/860 II', imageUrl: '/components/lci/DCS1020/KST 850-860 II.png' },
