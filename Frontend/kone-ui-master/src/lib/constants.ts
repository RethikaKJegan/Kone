...
export const KONE_COMPONENTS: ComponentItem[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'lci-surface-up-down', label: 'LCI Surface - Up/Down', imageUrl: '/components/lci/lci-surface-up-down.png' },
      ...
      { id: 'destination-surface', label: 'Destination Surface', imageUrl: '/components/lci/Destination Surface.jpg' },
      { id: 'destination-surface-1', label: 'Destination Surface 1', imageUrl: '/components/lci/Destination Surface_1.jpg' },
      ...
      { id: 'advance-guidance-dual', label: 'Advance Guidance - Dual', imageUrl: '/components/lci/Advance Guidance - Dual.png' },
