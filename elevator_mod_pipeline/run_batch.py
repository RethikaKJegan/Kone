...
VIDEO_MODE_ALIASES = {
    "pan": {"motion_style": "pan"},
    "pan_lr": {"motion_style": "pan"},
    "panel_lr": {"motion_style": "pan"},
    "pane_lr": {"motion_style": "pan"},
    "panle_lr": {"motion_style": "pan"},
    "panel_l_r": {"motion_style": "pan"},
    "pan_l_r": {"motion_style": "pan"},
    "pan_rl": {"motion_style": "pan"},
    "panel_rl": {"motion_style": "pan"},
    "pane_rl": {"motion_style": "pan"},
    "panle_rl": {"motion_style": "pan"},
    "panel_r_l": {"motion_style": "pan"},
    "pan_r_l": {"motion_style": "pan"},
